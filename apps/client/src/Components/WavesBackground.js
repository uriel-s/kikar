  ...
  useEffect(() => {
    ...
    for (let i = 0; i < waveConfig.waveCount; i++) {
      ...
      waves.push({
        ...
        speed: (0.001 - i * 0.00008) * waveConfig.speedMultiplier,
    ...
    const render = () => {
      ...
      [...waves].reverse().forEach((wave) => {
        ...
        for (let x = 0; x < canvas.width; x += 3) {
          // Smaller step (3px) for smoother curves
          ...
          let y =
            canvas.height * wave.baseHeight +
            Math.sin(x * wave.waveLength + wave.offset) * wave.amplitude * 0.6 +
            Math.sin(x * wave.secondaryWaveLength + wave.secondaryOffset) *
              wave.amplitude *
        ...
        const waveGradient = ctx.createLinearGradient(
          0,
          canvas.height * wave.baseHeight - wave.amplitude * 1.5,
          0,
          canvas.height
        );
        ...
        for (let x = 0; x < canvas.width; x += 5) {
          // Can use larger steps for highlight
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleConfigChange("amplitude", parseFloat(e.target.value))
              }
              style={{ width: "100%" }}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleConfigChange("speedMultiplier", parseFloat(e.target.value))
              }
              style={{ width: "100%" }}
            />
          </div>
