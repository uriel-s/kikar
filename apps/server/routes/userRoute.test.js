...
const mockDb = {
    collection: jest.fn(() => ({
        doc: jest.fn(() => ({
            set: jest.fn().mockResolvedValue(Promise.resolve()),  // תמיד מחזיר Promise
            update: jest.fn().mockResolvedValue(Promise.resolve()),  // לא מוגבל לפעם אחת
