...
הקוד כבר בנוי למעבר הזה: כל הגישה לאחסון מרוכזת ב-`services/storageService.js`
...
**חלק א' — אחסון:**
`services/storageService.js` הוא הקובץ היחיד שנוגע ב-bucket. מחליפים את המימוש
